...
// সাইন-আপ / রেজিস্টার এন্ডপয়ент (ইউজার + ওয়ালেট একসাথে ট্রানজেকশনে তৈরি হবে)
app.post('/api/register', async (req, res) => {
    ...
    try {
        ...
        // সাথে সাথেই ওয়ালেট জিরো ব্যালেন্স দিয়ে ইনিশিয়ালাইজ হবে
...
// ডিপোজিট রিকোয়েস্ট জমা নেওয়ার এন্ডপয়েন্ট
